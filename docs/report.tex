...
\end{itemize}
This pattern decouples the action execution from the filter rule logic, making it easy to add new actions without modifying existing code.
